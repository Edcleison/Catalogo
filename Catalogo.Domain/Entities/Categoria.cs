...
namespace Catalogo.Domain.Entities
{
    public sealed class Categoria : Entity
    {
        ...
        private void ValidateDomain(string nome, string imagemUrl)
        {
            ...
            DomainExceptionValidation.When(nome.Length < 3, "O nome deve ter no mínimo 3 cartacteres");

            DomainExceptionValidation.When(imagemUrl.Length < 5, "O nome da imagem deve ter no mínimo 5 cartacteres");
